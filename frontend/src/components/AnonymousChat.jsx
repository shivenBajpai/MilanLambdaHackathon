...
export default function AnonymousChat(props) {
    ...
    return (
        <div class="relative z-10" aria-labelledby="modal-title" role="dialog" ariaModal="true">
            {/* For making background blur */}
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" ariaHidden="true"></div>
            {/* Buttons */}
